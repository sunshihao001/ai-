...
description: Method Wheel wrapper draft for GitHub Spec Kit `taskstoissues` command. Status: gated-draft. Port: D/F.
source: github/spec-kit/templates/commands/taskstoissues.md
status: gated-draft
port: D/F
---

# speckit-taskstoissues — Method Wheel Wrapper Draft
...
- Wrapper status: `gated-draft`
- Method Wheel port: `D/F`
- Command guardrail: GitHub side-effect handoff; requires repo/remote confirmation and owner approval.

## Upstream Command Metadata

- Upstream description: Convert existing tasks into actionable, dependency-ordered GitHub issues for the feature based on available design artifacts.
- Upstream template: `templates/commands/taskstoissues.md`
