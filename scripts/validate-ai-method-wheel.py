...
REQUIRED_FILES = [
    ...
    '.ai/research/fractals/10-practical-adoption-correction.md',
...
REQUIRED_MARKERS = {
    ...
    '.ai/research/fractals/09-long-theory.md': ['PARTIAL_ACCEPT + BRIDGE', 'A-port maximum safe boundary', 'A-port automatic loop shape', 'Final decision'],
    '.ai/research/fractals/10-practical-adoption-correction.md': ['PRACTICAL_BRIDGE + SANDBOX_ADOPT_CANDIDATE', 'Do not rebuild Fractals', 'D/E sandbox practical trial'],
